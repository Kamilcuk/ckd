 ...
 */
_ckd_fconst ckd_schar_t ckd_mk_schar_t(signed char value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uchar_t ckd_mk_uchar_t(unsigned char value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_shrt_t ckd_mk_shrt_t(short value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_ushrt_t ckd_mk_ushrt_t(unsigned short value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_int_t ckd_mk_int_t(int value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uint_t ckd_mk_uint_t(unsigned int value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_long_t ckd_mk_long_t(long value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_ulong_t ckd_mk_ulong_t(unsigned long value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_llong_t ckd_mk_llong_t(long long value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_ullong_t ckd_mk_ullong_t(unsigned long long value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_intmax_t ckd_mk_intmax_t(intmax_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uintmax_t ckd_mk_uintmax_t(uintmax_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_size_t ckd_mk_size_t(size_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_intptr_t ckd_mk_intptr_t(intptr_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uintptr_t ckd_mk_uintptr_t(uintptr_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_int8_t ckd_mk_int8_t(int8_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uint8_t ckd_mk_uint8_t(uint8_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_int_least8_t ckd_mk_int_least8_t(int_least8_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uint_least8_t ckd_mk_uint_least8_t(uint_least8_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_int_fast8_t ckd_mk_int_fast8_t(int_fast8_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uint_fast8_t ckd_mk_uint_fast8_t(uint_fast8_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_int16_t ckd_mk_int16_t(int16_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uint16_t ckd_mk_uint16_t(uint16_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_int_least16_t ckd_mk_int_least16_t(int_least16_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uint_least16_t ckd_mk_uint_least16_t(uint_least16_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_int_fast16_t ckd_mk_int_fast16_t(int_fast16_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uint_fast16_t ckd_mk_uint_fast16_t(uint_fast16_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_int32_t ckd_mk_int32_t(int32_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uint32_t ckd_mk_uint32_t(uint32_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_int_least32_t ckd_mk_int_least32_t(int_least32_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uint_least32_t ckd_mk_uint_least32_t(uint_least32_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_int_fast32_t ckd_mk_int_fast32_t(int_fast32_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uint_fast32_t ckd_mk_uint_fast32_t(uint_fast32_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_int64_t ckd_mk_int64_t(int64_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uint64_t ckd_mk_uint64_t(uint64_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_int_least64_t ckd_mk_int_least64_t(int_least64_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uint_least64_t ckd_mk_uint_least64_t(uint_least64_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_int_fast64_t ckd_mk_int_fast64_t(int_fast64_t value, bool overflow) {
 ...
 * state indicated by overflow.
 */
_ckd_fconst ckd_uint_fast64_t ckd_mk_uint_fast64_t(uint_fast64_t value, bool overflow) {
...
_ckd_fconst _ckd_schar _ckd_value_cschar(_ckd_cschar v) { return ckd_value(v); }
_ckd_fconst _ckd_schar _ckd_value_schar(_ckd_schar v) { return v; }
_ckd_fconst bool _ckd_overflow_cschar(_ckd_cschar v) { return ckd_overflow(v); }
_ckd_fconst bool _ckd_overflow_schar(_ckd_schar v) { (void)v; return 0; }
_ckd_fconst _ckd_uchar _ckd_value_cuchar(_ckd_cuchar v) { return ckd_value(v); }
_ckd_fconst _ckd_uchar _ckd_value_uchar(_ckd_uchar v) { return v; }
_ckd_fconst bool _ckd_overflow_cuchar(_ckd_cuchar v) { return ckd_overflow(v); }
_ckd_fconst bool _ckd_overflow_uchar(_ckd_uchar v) { (void)v; return 0; }
_ckd_fconst _ckd_shrt _ckd_value_cshrt(_ckd_cshrt v) { return ckd_value(v); }
_ckd_fconst _ckd_shrt _ckd_value_shrt(_ckd_shrt v) { return v; }
_ckd_fconst bool _ckd_overflow_cshrt(_ckd_cshrt v) { return ckd_overflow(v); }
_ckd_fconst bool _ckd_overflow_shrt(_ckd_shrt v) { (void)v; return 0; }
_ckd_fconst _ckd_ushrt _ckd_value_cushrt(_ckd_cushrt v) { return ckd_value(v); }
_ckd_fconst _ckd_ushrt _ckd_value_ushrt(_ckd_ushrt v) { return v; }
_ckd_fconst bool _ckd_overflow_cushrt(_ckd_cushrt v) { return ckd_overflow(v); }
_ckd_fconst bool _ckd_overflow_ushrt(_ckd_ushrt v) { (void)v; return 0; }
_ckd_fconst _ckd_int _ckd_value_cint(_ckd_cint v) { return ckd_value(v); }
_ckd_fconst _ckd_int _ckd_value_int(_ckd_int v) { return v; }
_ckd_fconst bool _ckd_overflow_cint(_ckd_cint v) { return ckd_overflow(v); }
_ckd_fconst bool _ckd_overflow_int(_ckd_int v) { (void)v; return 0; }
_ckd_fconst _ckd_uint _ckd_value_cuint(_ckd_cuint v) { return ckd_value(v); }
_ckd_fconst _ckd_uint _ckd_value_uint(_ckd_uint v) { return v; }
_ckd_fconst bool _ckd_overflow_cuint(_ckd_cuint v) { return ckd_overflow(v); }
_ckd_fconst bool _ckd_overflow_uint(_ckd_uint v) { (void)v; return 0; }
_ckd_fconst _ckd_long _ckd_value_clong(_ckd_clong v) { return ckd_value(v); }
_ckd_fconst _ckd_long _ckd_value_long(_ckd_long v) { return v; }
_ckd_fconst bool _ckd_overflow_clong(_ckd_clong v) { return ckd_overflow(v); }
_ckd_fconst bool _ckd_overflow_long(_ckd_long v) { (void)v; return 0; }
_ckd_fconst _ckd_ulong _ckd_value_culong(_ckd_culong v) { return ckd_value(v); }
_ckd_fconst _ckd_ulong _ckd_value_ulong(_ckd_ulong v) { return v; }
_ckd_fconst bool _ckd_overflow_culong(_ckd_culong v) { return ckd_overflow(v); }
_ckd_fconst bool _ckd_overflow_ulong(_ckd_ulong v) { (void)v; return 0; }
_ckd_fconst _ckd_llong _ckd_value_cllong(_ckd_cllong v) { return ckd_value(v); }
_ckd_fconst _ckd_llong _ckd_value_llong(_ckd_llong v) { return v; }
_ckd_fconst bool _ckd_overflow_cllong(_ckd_cllong v) { return ckd_overflow(v); }
_ckd_fconst bool _ckd_overflow_llong(_ckd_llong v) { (void)v; return 0; }
_ckd_fconst _ckd_ullong _ckd_value_cullong(_ckd_cullong v) { return ckd_value(v); }
_ckd_fconst _ckd_ullong _ckd_value_ullong(_ckd_ullong v) { return v; }
_ckd_fconst bool _ckd_overflow_cullong(_ckd_cullong v) { return ckd_overflow(v); }
_ckd_fconst bool _ckd_overflow_ullong(_ckd_ullong v) { (void)v; return 0; }
...
#define _ckd_value(X) \
        ...
        _ckd_ullong:  _ckd_value_ullong)(X)
...
#define _ckd_overflow(X) \
        ...
        _ckd_ullong:  _ckd_overflow_ullong)(X)
